...
SECRET_KEY = 'django-insecure-e)2s!zmhz_!ups01syrb*-=2@f6)@+u#hpc8e8_uda+u%w7f$h'
...
# настройки для авторизации и регистрации
...
# настройки для отправки письма на почту
